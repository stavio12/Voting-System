...
.BasePath = "https://vbeng-25e59.firebaseio.com/"
    ...
    Private Sub Ent_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub nextBtn_Click(sender As Object, e As EventArgs) Handles nextBtn.Click
        ...
        results = MsgBox("DO You Choose To Vote " + candidate + " As Your Entertainment Cordinator?", MsgBoxStyle.YesNo)
        If results = vbYes Then
            ...
            Dim voter = client.Set(("Voter/" + indexNo.Text + "/Entertainment"), candidate)
