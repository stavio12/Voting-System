...
.BasePath = "https://vbeng-25e59.firebaseio.com/"
    ...
    Private Sub nextBtn_Click(sender As Object, e As EventArgs) Handles nextBtn.Click
        ...
        results = MsgBox("DO You Choose To Vote " + candidate + " As Your Secretartial Candidate?", MsgBoxStyle.YesNo)
        If results = vbYes Then
            ...
            Dim voter = client.Set(("Voter/" + indexNo.Text + "/Secretary"), candidate)
            Financial.Show()
            Me.Hide()
        End If
    End Sub
