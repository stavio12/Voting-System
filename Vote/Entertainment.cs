    ...
    public partial class Entertainment : Form
    {
        ...
        private void nextBtn_Click(object sender, EventArgs e)
        {
            ...
            if (Voted != "")
            {
                ...
                string message = "You Voted For " + Voted + " As Entertainment?";
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    FirebaseResponse res = client.Set("VotedStudent/" + indexNo.Text + @"/Entertainment", entertainment);
                }

                { FirebaseResponse setVoter = client.Set(@"/StudentList/" + indexNo.Text + @"/Status", "Voted"); }
