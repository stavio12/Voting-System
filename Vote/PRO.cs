    ...
    public partial class PRO : Form
    {
        ...
        private void nextBtn_Click(object sender, EventArgs e)
        {
            ...
            if (details.isEqual(name, User)) //If index is correcct you get to choose candidate 
            {
                ...
                else MessageBox.Show("Please Select a Public Relations Officer Candidate");
            }
            else
            {
            ...
            if (Voted != "")
            {
                ...
                string message = "You Voted For " + Voted + " As Public Relations Officer?";
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    FirebaseResponse res = client.Set("VotedStudent/" + indexNo.Text + @"/PRO", pro);
                    this.Hide();
