    ...
    public partial class Sports : Form
    {
        ...
        private void nextBtn_Click(object sender, EventArgs e)
        {
            ...
            if (details.isEqual(name, User)) //If index is correcct you get to choose candidate 
            {
                ...
                else MessageBox.Show("Please Select a Sports Candidate");
            }
            else
            {
            ...
            if (Voted != "")
            {
                ...
                string message = "You Voted For " + Voted + " As Sports?";
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    FirebaseResponse res = client.Set("VotedStudent/" + indexNo.Text + @"/Sports", sports);
                    this.Hide();
